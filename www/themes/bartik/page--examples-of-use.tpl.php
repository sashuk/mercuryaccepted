        ...
        <div class="centered_wrap">
            ...
            <div class="right_wrap">
                <div class="middle_wrap">
                    <h2 class="c_displayinlineblock">Баня</h2>
                </div>
                ...
                <br>
                <br>
                <span class="block_title c_marbot30">Проекты данного примера использования</span>

                <div class="samples_use_projects">
                    <div class="item">
                ...
                <span class="block_title c_marbot30">Выполненные работы</span>

                <br>
                <br>

                <div class="samples_use_complete">
                    <div class="item">
                        <div class="img">
                            <a class="action_view_wrap c_hover_opacity07-10" href="#">
                                <div class="middle_wrap">
                                    <img src="/images/icon_action_view.png" alt=""/>
                                    <span>смотреть</span>
                                </div>
                            </a>
                            <div class="image_wrap" style="width: 100px;">
