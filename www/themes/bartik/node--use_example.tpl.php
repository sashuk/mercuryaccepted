    ...
    <div class="tmpl_sector_content">
        ...
        <div class="centered_wrap">
            ...
            <div class="right_wrap">
				...
				<span class="block_title c_marbot30">Выполненные работы</span><br><br>
				<?php print render($content['field_image_ex']); ?>
				<br>
                <br>
				<br>
                <span class="block_title c_marbot30">Проекты</span>
                <div class="samples_use_projects">
                    <?php print render($content['field_projects']); ?>
                </div>
                <br>
                <br>
            </div>
